...
object MonoidSpec extends Properties("Monoids..") {
  ...
  property ("listMonoid is a monoid") = monoid(listMonoid[List[Int]])
  ...
  property ("productMonoid is a monoid") = monoid(productMonoid(optionMonoid[Int]) (listMonoid[List[String]]))
